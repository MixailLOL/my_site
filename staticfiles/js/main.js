window.onload = function () {
	...
	let multi_credits_up = document.getElementById('multi_credits_up');
	let multi_credits_down = document.getElementById('multi_credits_down');
	let multi_gold_up = document.getElementById('multi_gold_up');
	let multi_gold_down = document.getElementById('multi_gold_down');
